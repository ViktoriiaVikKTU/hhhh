...
const RevealSection = ({ caption }) => {
  ...
  return (
    <div className="scene" data-snap-section>
      ...
      <button className="discover-btn" aria-label="Discover">
        <span className="discover-btn__text">Discover</span>
        <span className="discover-btn__circle">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path d="M5 12H19M19 12L13 6M19 12L13 18" stroke="#F4EDDD" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </span>
      </button>
    </div>
